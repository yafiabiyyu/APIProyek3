...
class MSaw:
    ...
    def normalisasi_api(self):
        data_all_normalisasi = []
        nim_data, nama_data,_ = self.ambil_data()
        data_normalisasi = self.normalisasi_data()
    ...
    def vector_data(self):
        bobot = self.perbaikan_data_bobot()
        normalisasi_data = self.normalisasi_data()
        vector_data_list = []
